...
%
% Waveform lengths should match T in setup_parameters (6000 s)
%
%
% JBR 9/24/19
...
addpath ('function');
startlist = './ORCA_detrend/evlist.txt'; %'NOISETC_SAMPLE2/eventtimes_ENAMtest.txt'; % list of start times for data download, this will be the beginning of the waveform so specify appropriately, signal of interest should not be at edges of time series
datalength = 6000; %7200; % length of time series after each start time in seconds (default 86400, code not thoroughly tested for other values)
saceventdata = '/Users/jrussel/RESEARCH/PROJ_YoungPacificORCA/DATA/EVENTS/IRIS_XX_5.5_detrend_18sta/'; % path to local sac files
